...
public class ProjectBangunDatar2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Luas lingkaran dengan panjang jari - jari 5 adalah " + lingkaran.hitungLuasLing(5));
        System.out.println("Luas lingkaran dengan panjang jari - jari 7.4 adalah " + lingkaran.hitungLuasLing(7.4) + "\n");
        
        System.out.println("Keliling lingkaran dengan panjang jari - jari 5 adalah " + lingkaran.hitungKelilingLing(5));
        System.out.println("Keliling lingkaran dengan panjang jari - jari 7.4 adalah " + lingkaran.hitungKelilingLing(7.4));
        System.out.println("\n------------------------------------------------------------------------------------\n");
